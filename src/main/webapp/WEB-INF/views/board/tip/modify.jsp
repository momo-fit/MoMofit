...
<head>
    ...
    <link rel="stylesheet" href="/resources/board/tip/css/writing.css">
                ...
                <div class="s_box_board">
                    <div class="writing">
                        ...
                        <form class="writing_form" 
                            action="/board/tip/modify" method="post">

                            <div class="writing_content">

                                <input type="hidden" name="board_no" value="${tipboard.board_no}">
                                ...
                                <select id="select_board" name="category_no" required>
                                    ...
                                    <option selected value="2">운동팁</option>
                                ...
                                <!-- 2. 제목 -->
                                <br>제목&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="text" class="writing_title" name="title" value="${tipboard.title}" required>
                                <br><br>
                                ...
                                <!-- 4. 내용 -->
                                내용<br>
                                <textarea class="textarea_content" name="text" required>${tipboard.text}</textarea>

                                <input type="hidden" name="board_like" value="${tipboard.board_like}">
                                <input type="hidden" name="hits" value="${tipboard.hits}">
                                <input type="hidden" name="img_check" value="${tipboard.img_check}">
                                <input type="hidden" name="user_no" value="${tipboard.user_no}">

                            </div>
                            
                        <!-- 목록 버튼 -->
                        <input type="button" class="list_btn" value="취소" onClick="location='/board/tip/list'"></input>
