...
<head>
    ...
    <!-- CSS : main_board_trade -->
    <link rel="stylesheet" href="/resources/board/trade/css/main_board_trade.css">
...
<body>
            ...
            <div class="section_wrap">
                <div class="view">
                    ...
                    <div class="content_wrap">
                        ...
                        <!-- 좋아요 -->
                        <div class="like_div">
                            <img src="/resources/board/trade/img/like.png" height="70" class="like_btn">
                    ...
                    <div class="btn_row">
                        ...
                        <button type="button" id="listBtn" class="btn btn-secondary btn-sm">목록</button></a>
    ...
    <!-- 중고거래뷰 자바스크립트 -->
    <script src="/resources/board/trade/js/main_board_trade.js"></script>
