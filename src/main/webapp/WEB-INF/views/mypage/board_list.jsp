                    ...
                    <div class="s_box_content">
                        ...
                        <table class="mypage-table font-14-400">
                            ...
                            <thead class="mypage-thead-tr">
                                <tr>
                                    <th>
                                        <div class="mypage-checkbox"><input type="checkbox" name="board-check" onclick='selectAll(this)'/></div>
                                        제목
                                    </th>
                                    <th>작성자</th>
                                    <th>작성일</th>
                            ...
                            <tbody>              	
                                <tr class="mypage-tbody-tr mypage-tr-border">
                                    ...
                                    <td class="mypage-table-title">
                                        <div>
                                            <div class="mypage-checkbox"><input type="checkbox" name="board-check"></div>
                                            <div class="mypage-title-content"><a href="#" class="mypage-link">우영우 안보는 어르신들 상황</a></div>
